  ...
  $con = mysql_query("SELECT id FROM suppliers WHERE eik = '$eik'"); $check = mysql_num_rows($con);

  if ($check == 0) {
mysql_query
  ("INSERT INTO suppliers (name , eik , dds_number , address , city , region , post_code , country, manager, contact_name , contact_phone, contact_phone_2, contact_fax , contact_email , contact_website , contact_info , iban , bic_code , bank_name, grupa, reg_date, dude_or_not, who_reg) 
     VALUES  
