...
if (!empty($_POST['add_comment'])) {
  ...
  mysql_query("INSERT INTO customer_comment (customer_id, comment, date, who) VALUES ('$id', '$add_comment', NOW(), '$who')") or die (mysql_error());
