...
?>
		...
		<div id="content">
			...
			mysql_query("UPDATE customer_groups SET group_name='$name',discount='$discount',group_info='$group_info',update_date='$update_date' WHERE id='$id'");
			
			}
			$edd=mysql_fetch_array(mysql_query("SELECT * FROM customer_groups WHERE id='$id'"));
