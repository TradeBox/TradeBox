...
include("customer_edit_complete.php");

$id = $_GET['id'];
$con = mysql_query("SELECT * FROM customers WHERE id = $id");
...
<div id="orderform">
		...
		<li style="width: 100%; padding: 65px 5px 10px;">
			...
			document.getElementById('redyes2').style.visibility="hidden";
			 ...
			 contact_website.disabled=false;     grupa.disabled=false; 
    			...
    			<input class="gray addSubAccount" type="button" name="redyes" id="redyes" value="Редактирай клиента" onclick="edit_customer()" 
  ...
  <option value="nov_klient">Нов Клиент</option>
				...
				<td>
				<input class="gray addSubAccount" type="button" name="redyes2" id="redyes2" value="Редактирай клиента" onclick="edit_customer()" 
				 style="float: right; margin-top: 3px;">
			...
			<ul class="checkboxes">
															<?php $con3 = mysql_query("SELECT * FROM customer_comment WHERE customer_id	= $id ORDER BY id DESC");
