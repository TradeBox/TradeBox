...
?>
		...
		<div id="content">
			...
			mysql_query("INSERT INTO customer_groups (group_name,discount,group_info,update_date) VALUES ('$name','$discount','$group_info','$update_date')");
			add_to_archive('Потребителят добави нова Група '.$name.'');
			}
...
<div id="orderform">
		...
		<li style="width: 100%;">
			...
			<table>
				...
				<tr>
					...
					<td>
						<input style="" id="discount" name="discount" value="" type="text">
					</td>
				</tr>
				<tr>
					<th>Информация</th>
					<td>
						<input style="" id="group_info" name="group_info" value="" type="text">
					</td>
				</tr>
				<tr>
					<th>Дата на обновяване</th>
					<td>
						<input style="" id="update_date" name="update_date" value="" type="text">
					</td>
    ...
    text-shadow: 0 1px 0 white;" name="submit" value="Добавяне" type="submit"></td></tr>	
			</tbody></table>
		</li>
